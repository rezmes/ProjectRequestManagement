...
//     Title: assessment.activity || "No Activity",
//     RequestIDId: requestId, // Associate with the ProjectRequest
//     [`${type}Id`]: resource.item ? resource.item.key : null, // Use the key of the selected dropdown item
//     [`${type}Quantity`]: resource.quantity,
...
//     .execute()
//     .then(() => {
//       return Promise.all(createdItems); // Return all created items
//     })
//     .then((results) => {
//       // Extract and return the IDs of the created TechnicalAssessments
